            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.orientation === 'middle') {
                    var customThemeMiddle = document.createElement('style'),
                        cssRuleMiddle = 'div#tarteaucitronRoot.tarteaucitronBeforeVisible:before {content: \'\';position: fixed;width: 100%;height: 100%;background: white;top: 0;left: 0;z-index: 999;opacity: 0.5;}div#tarteaucitronAlertBig:before {content: \'\';font-size: 50px;}body #tarteaucitronRoot div#tarteaucitronAlertBig {width: 60%;min-width: 285px;height: auto;margin: auto;left: 50%;top: 50%;transform: translate(-50%, -50%);box-shadow: 0 0 9000px #000;border-radius: 20px;padding: 50px 0;}span#tarteaucitronDisclaimerAlert {padding: 0 30px;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {margin: 50px 0;display: block;text-align: center;font-size: 21px;}';
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                    ...
                    html += '   <h1 id="tarteaucitronTitle"> Gestion des cookies </h1>';
                    html += '       ' + tarteaucitron.lang.alertBigPrivacy;
                    html += '  <div id="tarteaucitronPol"> <a id="tarteaucitronLien" href=" ' + drupalSettings.confident + '" >  Consulter la politique de confidentialité </a> </div>';
                    html += '   </span>';
            ...
            if (document.getElementById(id) !== null) {
                ...
                if (property == "display" && value == "none" && (id == "tarteaucitron" || id == "tarteaucitronBack" || id == "tarteaucitronAlertBig")) {
                    ...
                    if (property == "display" && value == "block" && (id == "tarteaucitron" || id == "tarteaucitronAlertBig")) {
                     ...
                     // cadre du popup
                        document.getElementById(id).style["opacity"] = "0";
                  //      document.getElementById(id).style["padding-top"] = "20px";
                  
                            console.log(drupalSettings.logo);
                            console.log(drupalSettings.couleur1);
                        if(drupalSettings.couleur1){
                            document.getElementById(id).style["background"] = "url(" + drupalSettings.logo + ") " + drupalSettings.couleur1 + " top 50px center no-repeat"; 
                        }else{
                            document.getElementById(id).style["background"] = "url(" + drupalSettings.logo + ") #333 top 50px center no-repeat"; 
                        }
                        document.getElementById(id).style["background-size"] = "80px 80px";
                        document.getElementById(id).style["border"] = "solid " + drupalSettings.couleur2;
                        document.getElementById(id).style["box-shadow"] = "none";
                       
                       
                         //titre du popup
                         var titlePopup = document.getElementById("tarteaucitronTitle");
                         titlePopup.style["text-align"] = "center";
                         if(drupalSettings.couleur2){
                             titlePopup.style["color"] = drupalSettings.couleur2;
                         }else{
                              titlePopup.style["color"] = "#fff";
                         }
                         titlePopup.style["font-weight"] = 800;
                         titlePopup.style["margin-bottom"] = "30px";
                       
                       
                        //texte du popup
                        var txtPopup = document.getElementById("tarteaucitronDisclaimerAlert");
                        txtPopup.style["color"] = drupalSettings.couleur2;
                        if(drupalSettings.logo ){
                            txtPopup.style["margin"] = "130px 0 50px 0";
                        }
                        else{
                            txtPopup.style["margin"] = "20px 0 50px 0";
                        }                        
                        
                        //politique de confidentialité
                        var divPol = document.getElementById("tarteaucitronPol");
                        divPol.style["text-align"] = "center";
                        divPol.style["margin-top"] = "15px";
                        
                        //Lien 
                        var lienPol = document.getElementById("tarteaucitronLien");
                        lienPol.style["color"] = drupalSettings.couleur2;
                        lienPol.style["font-size"] = "13px";
                        
                        
                        // bouton 'accepter'
                        var buttonOk = document.getElementById("tarteaucitronPersonalize2");
                        buttonOk.style["background"] = drupalSettings.couleur2;
                        buttonOk.style["color"] = drupalSettings.couleur1;
                        buttonOk.style["border-radius"] = "5px";
                        buttonOk.style["font-weight"] = 800;
                        
                        //bouton 'personnaliser'
                        var buttonPerso = document.getElementById("tarteaucitronCloseAlert");
                        buttonPerso.style["background"] = drupalSettings.couleur1;
                        buttonPerso.style["color"] = drupalSettings.couleur2;
                        buttonPerso.style["border-radius"] = "5px";
                        buttonPerso.style["border"] = "solid " + drupalSettings.couleur2;
